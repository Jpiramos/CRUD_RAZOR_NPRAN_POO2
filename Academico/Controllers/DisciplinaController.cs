...
namespace Academico.Controllers
{
    public class DisciplinaController : Controller
    {
        ...
        public async Task<IActionResult> Create(Disciplina disciplina,CursoDisciplina cursoDisciplina)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                cursoDisciplina.DisciplinaId = disciplina.DisciplinaID;
                _context.Add(cursoDisciplina);
                await _context.SaveChangesAsync();
                return RedirectToAction(nameof(Index));
            }
            ViewBag.CursoId = new SelectList(_context.Cursos.ToList(), "Id", "Nome", cursoDisciplina.CursoId);
            return View(disciplina);
        }
